...
type ValueObjectValue<T> = T extends PrimitiveTypes ? T : T extends {
    value: infer U;
} ? U extends PrimitiveTypes ? U : ValueObjectValue<U> : T extends Array<{
    value: infer U;
}> ? U extends PrimitiveTypes ? U[] : Array<ValueObjectValue<U>> : T extends Array<infer U> ? Array<ValueObjectValue<U>> : T extends {
