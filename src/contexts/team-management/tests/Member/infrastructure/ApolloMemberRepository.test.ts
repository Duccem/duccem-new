...
import { ApolloMemberRepository } from "../../../src/Member/infrastructure/ApolloMemberRepository";
...
describe('ApolloMemberRepository', () => {
  ...
  let repository: ApolloMemberRepository;
  beforeEach(() => {
    client = {
      mutate: jest.fn().mockResolvedValue({ data: null }),
      query: jest.fn(),
    } as unknown as ApolloClient<NormalizedCacheObject>;
    repository = new ApolloMemberRepository(client);
  });
