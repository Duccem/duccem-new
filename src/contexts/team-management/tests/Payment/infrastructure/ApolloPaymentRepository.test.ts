...
import { ApolloPaymentRepository } from "../../../src/Payment/infrastructure/ApolloPaymentRepository";

describe('[PAYMENT][INFRA] ApolloPaymentRepository', () => {
  let client: ApolloClient<NormalizedCacheObject>;
  let repository: ApolloPaymentRepository;
  ...
  beforeEach(() => {
    ...
    repository = new ApolloPaymentRepository(client);
  });
